...
class Driver {
	...
	void Run (string[] args) {
		...
		ninja.WriteLine ("emcc_flags = -Os -s ALLOW_MEMORY_GROWTH=1 -s \"BINARYEN_TRAP_MODE='clamp'\" -s EMULATED_FUNCTION_POINTERS=1 -s NO_EXIT_RUNTIME=1 -s \"EXTRA_EXPORTED_RUNTIME_METHODS=['ccall', 'FS_createPath', 'FS_createDataFile', 'cwrap', 'setValue', 'getValue', 'UTF8ToString']\"");
