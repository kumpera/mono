...
$(TOP)/sdks/builds/toolchains/emsdk:
	...
	cd $(TOP)/sdks/builds/toolchains/emsdk && ./emsdk install emscripten-incoming-64bit
	cd $(TOP)/sdks/builds/toolchains/emsdk && ./emsdk activate --embedded emscripten-incoming-64bit
