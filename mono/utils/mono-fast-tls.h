...
enum {
	...
	MONO_TLS_JIT_TLS,
	MONO_TLS_THREAD,
	MONO_TLS_SGEN_TLAB_NEXT,
	MONO_TLS_SGEN_TLAB_TEMP_END,
	MONO_TLS_KEY_COUNT
};
...
*/
gint32 mono_tls_get_offset (MonoFastTlsKey key) MONO_INTERNAL;
